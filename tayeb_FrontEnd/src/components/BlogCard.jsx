...
<div className='col-12 col-md-6 col-lg-3 mb-4'>
    <div className='card border-0 shadow-lg h-100'> {/* استخدم h-100 لتوحيد الارتفاع */}
        <img src={showImage(blog.image)} className='card-img-top' />
        <div className='card-body d-flex flex-column'> {/* اضف flex-column للترتيب العمودي */}
            <h2 className='h5'>{blog.title}</h2>
            <p className='flex-grow-1'>{blog.shortDesc}</p> {/* flex-grow-1 لجعل النص يتمدد حسب الحاجة */}
            <div className='d-flex justify-content-between mt-auto'> {/* يضمن التثبيت السفلي للأزرار */}
